...
// =====================================
// ✅ SECTION 2: MAIN HANDLER FUNCTION
// =====================================
const handleSubmitLiveWorkshop = async (req, res) => {
  try {
    ...
    // ------------------------
    // 🔍 ตรวจสอบ Ref + Serial จาก auth_sessions
    // ------------------------
    ...
    // ✅ Step 1: Insert เข้า adt_workshop_attendees
    ...
    // ✅ Step 2: อัปเดต auth_sessions ด้วยชื่อ-สกุล-เบอร์โทร
    await supabase
      .from('auth_sessions')
      .update({
        first_name,
    ...
    // ✅ Step 3: ส่ง Flex Message
    await sendFlexToUser(line_user_id, {
      title: "🎓 ยินดีต้อนรับเข้าสู่ ADTLive Workshop",
      imageUrl: "https://wpxpukbvynxawfxcdroj.supabase.co/storage/v1/object/public/adtliveworkshop/Live03.jpg",
...
// =====================================
// ✅ SECTION 3: FLEX MESSAGE FUNCTION
// =====================================
