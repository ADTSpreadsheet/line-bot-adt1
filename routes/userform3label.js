...
router.post('/get-message', async (req, res) => {
  ...
  const responseMessage = {
    ...
    stage2: 'ขั้นตอนที่ 2  ตอนนี้สำคัญมากนะครับ ! พี่ต้องกรอกให้ถูก เพราะถ้าผิด เกิน 3 รอบเครื่องพี่จะถูกล๊อคและเข้าระบบไม่ได้ครับผม ได้รหัส Serial key มาแล้ว กรอกให้เรียบร้อยแล้วกดปุ่ม Confirm ขอให้โชคดีนะครับ',
